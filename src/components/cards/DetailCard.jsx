...
/**
 * DaiailCard is responsible for showing the details or a certain point on map.
 * @param {data} param is the information of all the points on map 
 * @returns 
 */
export const DetailCard = ({ data }) => {
  ...
  /**
   * 
   * @returns src of the selected point
   */
  const getImage = () => {
    if (data?.points === "1A") {
      return  A1;
